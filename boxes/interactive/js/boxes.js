...
enterSelectMode = function (selected) {
  ...
  $content.each(function (i) {
    $(this).find('.box').append("<input type='checkbox' name='boxes'><span></span></input>").click(function (e) {
      var $check;
  ...
  $toolbar.empty().append("<button id='cancelselecting' class='fl'>Cancel</button>").find('#cancelselecting')
    ...
    }).end().append("<button id='delete_box' class='fr action'>Delete</button>").find('#delete_box')
      .click(function () {
        var $notify = $("#notify"),
        $undobutton = {};
